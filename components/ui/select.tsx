...
const SelectItem = React.forwardRef<
  React.ElementRef<typeof SelectPrimitive.Item> & {iconNode?: React.ReactNode},
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Item> & {iconNode?: React.ReactNode}
>(({ className, children, iconNode, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon> {iconNode} </SelectPrimitive.Icon>
